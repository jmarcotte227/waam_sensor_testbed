...
wavelengths = np.loadtxt('spec_wavelengths.csv', delimiter=',', skiprows=1)[0,1:]
counts = np.loadtxt('spec_counts.csv', delimiter=',', skiprows=1)
...
ani = animation.FuncAnimation(
    fig, animate, interval=20, blit=True, frames=length)
